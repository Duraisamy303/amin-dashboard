                ...
                renderComponent={() => (
                    <>
                        <div className=" p-3">
                            ...
                            {precentageErrMsg && <div className="text-red-500 mt-1">{precentageErrMsg}</div>}
                            {fixedErrMsg && <div className="text-red-500 mt-1">{fixedErrMsg}</div>}{' '}
                            <div className="flex justify-end gap-5 mt-5">
                                <button className="rounded border border-black bg-transparent px-4 py-2 font-semibold text-black hover:border-transparent hover:bg-blue-500 hover:text-white" onClick ={() => setState({ isOpenCoupen: false })}>
                                    Cancel
                                </button>
                                <button
                                    onClick={() => {
